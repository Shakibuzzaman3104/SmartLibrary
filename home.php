...
<body>
  ...
  <div id="myCarousel" class="carousel slide" data-ride="carousel">
	...
	<div class="Lowerr">
	<p><h4>Students sometime travel a long way to study in the library but sometimes reaching there they find no table available for them. This system allow students to book table from anywhere using online interface and it also helps them to see if there is any table available or not.</h4> </p><br><br>

	<p><h4>The locker occupying process has been made easier and hassle-free. Instead of using keys, students will be able to use their ID card to occupy a locker. Later, they can use the ID card and online interface to control the locker occupied by them.</h4></p>
	</div>
	</div>	
